 ...
 * @param    {Object}
 */
ImageMedia.setMethod(function thumbnail(render, record) {
	...
	this.veronica.getResizedImage(record.MediaFile.path, options, function(err, resizedPath) {
...
ImageMedia.setMethod(function serve(conduit, record) {
	...
	if (resizeOptions) {
		...
		this.veronica.getResizedImage(record.MediaFile.path, resizeOptions, function(err, resizedPath) {
